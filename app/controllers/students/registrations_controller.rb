...
class Students::RegistrationsController < Devise::RegistrationsController
  ...
  def update_params
    params.require(:student).permit(:first_name, :last_name, :description, :profile, :school, :photo, :wanted_area, :disponibility, :phone_number, :year, :mobility, dossiers: [])
  end
  ...
  def configure_permitted_parameters
    ...
    attributes = [:first_name, :last_name, :email, :photo, :profile, :school, :tongues, :password, :password_confirmation, :description, :phone_number, :year, :wanted_area, :disponibility, :mobility, dossiers: []]
